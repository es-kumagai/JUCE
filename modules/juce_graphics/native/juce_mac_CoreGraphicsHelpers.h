...
JUCE_PUBLIC_FUNCTION CGImageRef juce_createCoreGraphicsImage (const Image&, CGColorSpaceRef, bool mustOutliveSource);
JUCE_PUBLIC_FUNCTION CGContextRef juce_getImageContext (const Image&);
...
#if JUCE_MAC
 JUCE_PUBLIC_FUNCTION NSImage* imageToNSImage (const Image& image, float scaleFactor = 1.0f);
#endif
